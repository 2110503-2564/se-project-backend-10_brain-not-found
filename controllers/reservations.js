...
//@access   Public
exports.getResurvations = async (req,res,next) => {
    let query;
...
//@access Public
exports.getResurvation = async (req,res,next) => {
    try {
...
//@access Private
exports.addResurvation = async (req,res,next) => {
    try {
...
//@access Private
exports.updateResurvation = async (req,res,next) => {
    try{
...
//@access Private
exports.deleteResurvation = async (req,res,next) => {
    try{
        let appointment = await Appointment.findById(req.params.id);
